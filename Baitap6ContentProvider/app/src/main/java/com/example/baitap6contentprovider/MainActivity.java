package com.example.baitap6contentprovider;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnShowAllContacts = findViewById(R.id.btnShowAllContacts);
        Button btnAccessCallLog = findViewById(R.id.btnAccessCallLog);
        Button btnAccessSMS = findViewById(R.id.btnAccessSMS);
